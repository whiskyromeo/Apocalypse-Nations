    ...
    public void StartApocolypse()
    {
        ...
        switch (rand)
        {
            case 0:
				...
				button0.GetComponentInChildren<Text>().text = ApocalypseConstants.FAMINE_SOLVE_BUTTON_0_TEXT + "(-40 Economy, -30 Science)";
				button1.GetComponentInChildren<Text>().text = ApocalypseConstants.FAMINE_SOLVE_BUTTON_1_TEXT + "(-50 Military)";
            ...
            case 2:
				...
				button0.GetComponentInChildren<Text>().text = ApocalypseConstants.ANGELS_SOLVE_BUTTON_0_TEXT + "(-40 Military, - 40 Science)";
				button1.GetComponentInChildren<Text>().text = ApocalypseConstants.ANGELS_SOLVE_BUTTON_1_TEXT + "(-90 Religion)";
                foreach (Alliance player in gameManager.players)
                {
            ...
            case 4:
				...
				button0.GetComponentInChildren<Text>().text = ApocalypseConstants.ZOMBIES_SOLVE_BUTTON_0_TEXT + "(-50 Economy, -50 Science)";
				button1.GetComponentInChildren<Text>().text = ApocalypseConstants.ZOMBIES_SOLVE_BUTTON_1_TEXT + "(-60 Military)";
                foreach (Alliance player in gameManager.players)
                {
    ...
    public void StartEvent(ApoclypseTypes currentApoclypse)
    {
            ...
            if (currentApoclypse == ApoclypseTypes.Famine)
            {
                switch (random)
                {
                    case 7:
						...
						button0.GetComponentInChildren<Text>().text = ApocalypseConstants.FAMINE_MUTATION_SOLVE_TEXT1 + "(-15 Economy, -20 Science)";
                    ...
                    case 8:
						...
						button0.GetComponentInChildren<Text>().text = ApocalypseConstants.FAMINE_PLAGUE_SOLVE_TEXT0 + "(-40 Religion)";
						button1.GetComponentInChildren<Text>().text = ApocalypseConstants.FAMINE_PLAGUE_SOLVE_TEXT1 + "(-10 Economy, -10 Military, -10 Science)";
                        foreach (Alliance player in gameManager.players)
                        {
                    ...
                    case 9:
						...
						button0.GetComponentInChildren<Text>().text = ApocalypseConstants.FAMINE_EVOLUTION_SOLVE_TEXT0 + "(-30 Science)";
						button1.GetComponentInChildren<Text>().text = ApocalypseConstants.FAMINE_EVOLUTION_SOLVE_TEXT1 + "(-30 Military)";
                        foreach (Alliance player in gameManager.players)
                        {
                    ...
                    case 10:
						...
						button0.GetComponentInChildren<Text>().text = ApocalypseConstants.FAMINE_BREAKTHROUGH_SOLVE_TEXT + "(+30 Science)";
                        button1.GetComponentInChildren<Text>().text = "";
                        foreach (Alliance player in gameManager.players)
                        {
            ...
            else if(currentApoclypse == ApoclypseTypes.Angels)
            {
                switch (random)
                {
                    case 7:
						...
						button0.GetComponentInChildren<Text>().text = ApocalypseConstants.ANGELS_MINIONS_SOLVE_TEXT + "(-30 Military)";
                        button1.GetComponentInChildren<Text>().text = "";
                        foreach (Alliance player in gameManager.players)
                        {
                    ...
                    case 8:
						...
						button0.GetComponentInChildren<Text>().text = ApocalypseConstants.ANGELS_HELLFIRE_SOLVE_TEXT + "(-40 Religion)";
                        button1.GetComponentInChildren<Text>().text = "";
                        foreach (Alliance player in gameManager.players)
                        {
                    ...
                    case 9:
						...
						button0.GetComponentInChildren<Text>().text = ApocalypseConstants.ANGELS_PLAGUE_SOLVE_TEXT + "(-20 Religion, -20 Science)";
                        button1.GetComponentInChildren<Text>().text = "";
                        foreach (Alliance player in gameManager.players)
                        {
            ...
            else if (currentApoclypse == ApoclypseTypes.Zombies)
            {
                switch (random)
                {
                    case 7:
						...
						button0.GetComponentInChildren<Text>().text = ApocalypseConstants.ZOMBIES_EVOLUTION_SOLVE_TEXT + "(-40 Economy)";
                        button1.GetComponentInChildren<Text>().text = "";
                        foreach (Alliance player in gameManager.players)
                        {
                    ...
                    case 8:
						...
						button0.GetComponentInChildren<Text>().text = ApocalypseConstants.ZOMBIES_HORDE_SOLVE_TEXT0 + "(-40 Military)";
						button1.GetComponentInChildren<Text>().text = ApocalypseConstants.ZOMBIES_HORDE_SOLVE_TEXT1 + "(-20 Economy, -20 Science)";
                        foreach (Alliance player in gameManager.players)
                        {
                    ...
                    case 10:
						...
						button0.GetComponentInChildren<Text>().text = ApocalypseConstants.ZOMBIES_MUTATION_SOLVE_TEXT + "(-15 Economy, -15 Science)";
                        button1.GetComponentInChildren<Text>().text = "";
                        foreach (Alliance player in gameManager.players)
                        {
        ...
        else
        {
            ...
            switch (rand)
            {
				...
				button0.GetComponentInChildren<Text>().text = ApocalypseConstants.WEATHER_SOLVE_TEXT + "(-20 Economy)";
                    button1.GetComponentInChildren<Text>().text = "";
                    foreach (Alliance player in gameManager.players)
                    {
				...
				button0.GetComponentInChildren<Text>().text = ApocalypseConstants.DROUGHT_EVENT_SOLVE + "(-15 Economy, -15 Military)";
                    button1.GetComponentInChildren<Text>().text = "";
                    foreach (Alliance player in gameManager.players)
                    {
